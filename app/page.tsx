    ...
    <main className="min-h-screen mx-auto max-w-[692px] px-6 py-12 sm:py-16">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="space-y-4 text-base text-neutral-400 leading-relaxed">
          <p>
            I'm currently a Staff Product Designer at Kajabi where I've driven & evolved the core platform experience over the last 8 years. I've designed the moments that define our product: 0–1 launches, systems that scale, and AI frameworks that change how people build businesses.
          </p>
          <p>
